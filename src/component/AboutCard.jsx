...
const AboutCard = () => {
  return (
    <div className="bg-gray-100 p-4 lg:p-8 flex flex-col lg:flex-row items-start gap-3">
      <img src={about} alt="About Us" className="w-full lg:w-1/2 lg:mr-8 rounded-lg" />
