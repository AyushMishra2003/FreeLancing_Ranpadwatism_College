...
const AboutCard = () => {
  return (
    <div className="bg-gray-100 p-4 lg:p-8 flex flex-col lg:flex-row items-center justify-center">
      ...
      <div className="lg:w-1/2 flex flex-col gap-2">
        ...
        <p className="text-base lg:text-lg text-justify lg:text-left leading-relaxed">
        ...
        <button
          className=" w-fit bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
        >
          View More
        </button>
      </div>
